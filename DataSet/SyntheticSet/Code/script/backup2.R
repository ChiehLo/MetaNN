  ...
  for(i2 in 1:length(p2)){
    for(i3 in 1:length(p3)){
      ...
      for (IT in 1:10){
        ...
        postfix = paste("_", p1[i1], "_", p2[i2], "_", p3[i3], sep = "");
        train_sample_file <- paste("/Users/chiehlo/Desktop/HMP_project/deep/Synthetic/IT", IT, "/TrainSampleSynthetic_",  IT , postfix, ".txt", sep = "");
        train_label_file <- paste("/Users/chiehlo/Desktop/HMP_project/deep/Synthetic/IT", IT, "/TrainLabelSynthetic_", IT, postfix, ".txt", sep = "");
        test_sample_file <- paste("/Users/chiehlo/Desktop/HMP_project/deep/Synthetic/IT", IT, "/TestSampleSynthetic_",  IT , postfix, ".txt", sep = "");
        test_label_file <- paste("/Users/chiehlo/Desktop/HMP_project/deep/Synthetic/IT", IT, "/TestLabelSynthetic_", IT, postfix, ".txt", sep = "");
...
#         if(runif(1,0,1) > p3){
#           new_data[i] = new_data[i] + sample.int(5, 1, replace = T )
#           #new_data[i] = new_data[i] + round(new_data[i]) 
#           count = count + 1 
#         }
#         else{
#           new_data[i]  = 0
