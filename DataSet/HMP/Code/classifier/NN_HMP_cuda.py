...
parser = argparse.ArgumentParser(description='HMP datasets')
...
pp = np.array([0, 50, 75, 100, 150, 200, 250, 500, 1000, 1500])

prefix = '../../Data/Splits/IT'
prefix_aug = '../../Data/Augmentation/IT'
if CNN_flag:
    prefix_save = '../../Data/Results_CNN/' + str(RSEED) + '/IT'
else:
    prefix_save = '../../Data/Results_MLP/' + str(RSEED) + '/IT'
...
for it in range(len(IT)):
    ...
    sample_file = prefix + str(IT[it]) + '/TrainSampleHMP_' + str(IT[it]) + '.txt'
    label_file = prefix + str(IT[it]) + '/TrainLabelHMP_' + str(IT[it]) + '.txt'
    ...
    sample_file = prefix + str(IT[it]) + '/TestSampleHMP_' + str(IT[it]) + '.txt'
    label_file = prefix + str(IT[it]) + '/TestLabelHMP_' + str(IT[it]) + '.txt'
    ...
    for cc in range(len(pp)):
        ...
        #### declare models
        if CNN_flag:
            net = CNN1d(n_feature=input_dim, out_dim = 160, n_output= output_dim)
        else:
        ...
        if CNN_flag:
            prefix_save_prob = '../../Data/Results_CNN/' + str(RSEED) + '/prob/IT'
        else:
            prefix_save_prob = '../../Data/Results_MLP/' + str(RSEED) + '/prob/IT'
