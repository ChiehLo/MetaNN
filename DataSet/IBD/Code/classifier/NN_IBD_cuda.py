...
parser = argparse.ArgumentParser(description='IBD datasets')
...
pp = np.array([0, 50, 75, 100, 150, 200, 500, 1000, 2000, 3000])

prefix = '../../Data/IBD/Splits/IT'
prefix_aug = '../../Data/IBD/Augmentation/IT'
if CNN_flag:
    prefix_save = '../../Data/IBD/Results_CNN/' + str(RSEED) + '/IT'
else:
    prefix_save = '../../Data/IBD/Results_MLP/' + str(RSEED) + '/IT'
...
for it in range(len(IT)):
    ...
    for cc in range(len(pp)):
        ...
        #### declare models
        if CNN_flag:
            net = CNN1d(n_feature=input_dim, out_dim = 512, n_output= output_dim)
        else:
        ...
        if CNN_flag:
            prefix_save_prob = '../../Data/IBD/Results_CNN/' + str(RSEED) + '/prob/IT'
        else:
            prefix_save_prob = '../../Data/IBD/Results_MLP/' + str(RSEED) + '/prob/IT'
        if drop_prob > 0:
