OTU <- read.table("/Users/chiehlo/Desktop/HMP_project/deep/MBenchmark/benchmarks/CS/CS_otus.txt")
Labels <- read.table("/Users/chiehlo/Desktop/HMP_project/deep/MBenchmark/benchmarks/CS/CS_labels.txt", sep = '\t')
test_indices <- read.table("/Users/chiehlo/Desktop/HMP_project/deep/MBenchmark/benchmarks/CS/CS_test_indices.txt", sep = '\t')
...
for (IT in 1:Total_split){
  ...
  train_sample_file <- paste("/Users/chiehlo/Desktop/HMP_project/deep/datasets/MBSet/Data/CS/Splits/IT", IT, "/TrainSample_",  IT , ".txt", sep = "");
  train_label_file <- paste("/Users/chiehlo/Desktop/HMP_project/deep/datasets/MBSet/Data/CS/Splits/IT", IT, "/TrainLabel_", IT, ".txt", sep = "");
  test_sample_file <- paste("/Users/chiehlo/Desktop/HMP_project/deep/datasets/MBSet/Data/CS/Splits/IT", IT, "/TestSample_",  IT , ".txt", sep = "");
  test_label_file <- paste("/Users/chiehlo/Desktop/HMP_project/deep/datasets/MBSet/Data/CS/Splits/IT", IT, "/TestLabel_", IT, ".txt", sep = "");
