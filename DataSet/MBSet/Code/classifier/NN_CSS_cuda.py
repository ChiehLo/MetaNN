...
parser = argparse.ArgumentParser(description='CSS datasets')
...
pp = np.array([0, 50, 75, 100, 150, 200, 600, 1200, 2400, 3600])


prefix = '../../Data/CSS/Splits/IT'
prefix_aug = '../../Data/CSS/Augmentation/IT'
if CNN_flag:
    prefix_save = '../../Data/CSS/Results_CNN/' + str(RSEED) + '/IT'
else:
    prefix_save = '../../Data/CSS/Results_MLP/' + str(RSEED) + '/IT'
for it in range(len(IT)):
    ...
    for cc in range(len(pp)):
        ...
        #### declare models
        if CNN_flag:
            net = CNN1d(n_feature=input_dim, out_dim = 296, n_output= output_dim)
        else:
            net = Net(n_feature=input_dim, n_hidden=h1_dim, n_hidden2 = h2_dim, n_output=output_dim)  
        ...
        if CNN_flag:
            prefix_save_prob = '../../Data/CSS/Results_CNN/' + str(RSEED) + '/prob/IT'
        else:
            prefix_save_prob = '../../Data/CSS/Results_MLP/' + str(RSEED) + '/prob/IT'
        if drop_prob > 0:
