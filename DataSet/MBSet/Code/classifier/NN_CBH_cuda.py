...
pp = np.array([0, 50, 75, 100, 150, 200, 300, 600, 1200, 1800])

prefix = '../../Data/CBH/Splits/IT'
prefix_aug = '../../Data/CBH/Augmentation/IT'
if CNN_flag:
    prefix_save = '../../Data/CBH/Results_CNN/' + str(RSEED) + '/IT'
else:
    prefix_save = '../../Data/CBH/Results_MLP/' + str(RSEED) + '/IT'
...
for it in range(len(IT)):
    ...
    for cc in range(len(pp)):
        ...
        if CNN_flag:
            net = CNN1d(n_feature=input_dim, out_dim = 728, n_output= output_dim)
        else:
        ...
        if CNN_flag:
            prefix_save_prob = '../../Data/CBH/Results_CNN/' + str(RSEED) + '/prob/IT'
        else:
            prefix_save_prob = '../../Data/CBH/Results_MLP/' + str(RSEED) + '/prob/IT'
        if drop_prob > 0:
