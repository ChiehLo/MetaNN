...
prefix = '../../Data/FSH/Splits/IT'
prefix_aug = '../../Data/FSH/Augmentation/IT'
prefix_save = '../../Data/FSH/Results_CNN/' + str(RSEED) + '/IT'
...
for it in range(len(IT)):
    ...
    for cc in range(len(pp)):
        ...
        if CNN_flag:
            prefix_save_prob = '../../Data/FSH/Results_CNN/' + str(RSEED) + '/prob/IT'
        else:
            prefix_save_prob = '../../Data/FSH/Results_MLP/' + str(RSEED) + '/prob/IT'
        if drop_prob > 0:
