...
for dataset in datasets:
	...
	prefix_save = '/Users/chiehlo/Desktop/HMP_project/deep/datasets/MBSet/Data/' + dataset + '/Results/' 
	print(dataset)
...
for dataset in datasets:
	...
	prefix_save = '/Users/chiehlo/Desktop/HMP_project/deep/datasets/' + names[count1] + '/Data/' + dataset + '/Results/' 
	print(dataset)
	print(n_classes[count1])
	tprs = []
	aucs = []
