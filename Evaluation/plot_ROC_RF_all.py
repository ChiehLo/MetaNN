...
for dataset in datasets:
	...
	prefix_save = '/Users/chiehlo/Desktop/HMP_project/deep/datasets/MBSet/Data/' + dataset + '/Results_RF/IT' 
	print(dataset)
	...
	for seed in range(nSeed):	
		for it in range(len(IT)):
			...
			for pp in range(len(PP)):
				save_path = prefix_save + str(IT[it]) + '_' + str(seed) + '.npy'
				test_prob = np.load(save_path)
...
for dataset in datasets:
	...
	prefix_save = '/Users/chiehlo/Desktop/HMP_project/deep/datasets/' + names[count1] + '/Data'  + '/Results_RF/IT' 
	print(dataset)
	print(n_classes[count1])
	tprs = []
	aucs = []
...
for dataset in datasets:
	...
	prefix_save = '/Users/chiehlo/Desktop/HMP_project/deep/datasets/' + names[count1] + '/Data/' + dataset + '/Results_RF/IT' 
	print(dataset)
	print(n_classes[count1])
	tprs = []
	aucs = []
