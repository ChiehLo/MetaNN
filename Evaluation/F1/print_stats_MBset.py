...
CNN_flag = True
if CNN_flag:
	save_path = '../../DataSet/MBSet/Data/' + par['dataset'] + '/Results/' + par['dataset'] + '_LR2' + '.npy'
else:
	save_path = '/Users/chiehlo/Desktop/HMP_project/deep/datasets/MBSet/Data/' + par['dataset'] + '/Results/' + par['dataset'] + '.npy'
...
if par['dataset'] == 'CBH' or par['dataset'] == 'FSH':
	nb_size = [0, 50, 75, 100, 150, 200, 300, 600, 1200, 1800]
elif par['dataset'] == 'CS':
	nb_size = [0, 50, 75, 100, 150, 200, 350, 700, 1400, 2100]
elif par['dataset'] == 'CSS':
	nb_size = [0, 50, 75, 100, 150, 200, 600, 1200, 2400, 3600]
else:
	nb_size = [0, 50, 75, 100, 150, 200, 300, 600, 900]
